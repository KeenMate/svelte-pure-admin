...
<svelte:head>
	<title>Checkbox Lists - Pure Admin Svelte</title>
</svelte:head>
	...
	<Grid>
		<Column size="100" md="50">
			<div style="display: flex; flex-direction: column; gap: 1.2rem;">
				...
				/>
				<div style="margin-left: 2.4rem; display: flex; flex-direction: column; gap: 0.8rem;">
		...
		<Column size="100" md="50">
			...
			<Paragraph class="pa-text pa-text--secondary" style="margin-top: 1.2rem;">
...
<Heading level={2} style="margin-bottom: 1.5rem;">Checkbox Lists</Heading>
...
<Card title="Alternative Layouts" subtitle="Inline, grid, and multi-column layouts">
	...
	<Heading level={4} style="margin-top: 1.5rem;">Grid Layout</Heading>
	...
	<Heading level={4} style="margin-top: 1.5rem;">Two-Column Layout</Heading>
	...
	<Heading level={4} style="margin-top: 1.5rem;">Three-Column Layout</Heading>
...
<Card title="Interactive Demo" subtitle="Select-all functionality and row selection">
	...
	{#snippet footer()}
		<div id="selection-info" style="font-size: 0.875rem; color: #666;">
